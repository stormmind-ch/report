...
#figure(
  image("images/training_fnn.png", width: 50%),
  caption: [Training of the #abbr.a[FNN]]
)<fnn_training>

#figure(
  image("images/cm_fnn.png", width: 50%),
