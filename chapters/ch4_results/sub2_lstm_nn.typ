...
#figure(table(columns: 4,
  ...
  [*Accuracy*],[$68.41% plus.minus script(0.02)$],[],[],
  [*AUC*], [$0.71 plus.minus script(2.4e-8)$],[],[],
  [*F1*], [$0.67 plus.minus script(2.2e-6)$],[],[],
  [*Precision*], [$0.68 plus.minus script(9.1e-6)$],[],[],
  [*Specificity*], [$0.67 plus.minus script(1.5e-6)$],[],[],
),
