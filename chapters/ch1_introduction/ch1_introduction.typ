...
RAvaFcast v1.0.0 @RAvaFcastKunstlicheIntelligenz is an artificial intelligence system designed to improve avalanche prediction in high-risk regions in Switzerland. The research is based on historical avalanche records and weather data. The approach follows a three-stage model pipeline consisting of classification, interpolation, and aggregation. Evaluation results demonstrated a strong correlation between model predictions and human expert assessments. @maissenThreestageModelPipeline2024