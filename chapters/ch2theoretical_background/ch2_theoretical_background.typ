...
The second part introduces the machine learning and deep learning concepts that underpin the modeling approach. It starts with basic #abbr.s[FNN] and progresses toward more advanced architectures tailored for sequential data, such as #abbr.a[RNN], #abbr.a[LSTM], and Transformer models. These architectures form the core of the predictive models developed in this thesis.
