...
Finally, we extend our sincere thanks to the #abbr.l[WSL] for collecting and providing the damage data, and to Patrick Zippenfenig for generously providing a free open-meteo API key, which made this project possible.